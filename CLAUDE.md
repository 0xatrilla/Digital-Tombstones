...
This is a native **iOS application** built with **Swift 6.1+** and **SwiftUI**. The codebase targets **iOS 26.0 and later**, allowing full use of modern Swift and iOS APIs. All concurrency is handled with **Swift Concurrency** (async/await, actors, @MainActor isolation) ensuring thread-safe code.
...
- **Entitlements File**: `Config/KilledByGoogle.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/KilledByGoogle.entitlements`:
